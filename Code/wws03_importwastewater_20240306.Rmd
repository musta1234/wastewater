...
ww_aus_hosp <- 
  ...
  mutate( #calculate the 7 day average of viral load while imputing missing values using the average 
...
ww_can_hosp <-
  left_join(ww_can_import, cases_can_import, by = c("date", "location_name")) %>%
