...
#ihme_102023 <- 
  read.csv(paste0(file_loc, "/Data/Covid-19 Explorer 2023-10-30.csv")) %>% 
...
pop <- 
  read_excel(paste0(file_loc, "/Data/", "world_pop_20231025_worldometer.xlsx")) %>% 
...
covariants <- 
  read.csv(paste0(file_loc, "/Data/CoVariants_Scrapped8.csv")) %>% 
  #select(-1) %>% View()
